...
const SVGCompiler = require('@leo-burnett-melbourne/svg-baker');
const spriteFactory = require('@leo-burnett-melbourne/svg-baker/lib/sprite-factory');
const Sprite = require('@leo-burnett-melbourne/svg-baker/lib/sprite');
